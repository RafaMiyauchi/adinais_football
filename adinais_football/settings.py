"""
Django settings for adinais_football project.
...
SECRET_KEY = 'django-insecure-u$^g30s$%tb4x&%4v_@yg_&@mrow=@lw-0$9c6b$i=&eex+1^t'
...
WSGI_APPLICATION = 'adinais_football.wsgi.application'
